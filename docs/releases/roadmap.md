...
GitHub 跟踪：v1.7.7 为 [Issue #5](https://github.com/Dante-Xr/solo-sales/issues/5)，v1.7.8 为 [Issue #6](https://github.com/Dante-Xr/solo-sales/issues/6)，v1.7.9 为 [Issue #7](https://github.com/Dante-Xr/solo-sales/issues/7)。v1.8.0、v1.8.1、v1.9.0 和 v2.0.0 分别使用 [Issue #8](https://github.com/Dante-Xr/solo-sales/issues/8)、[Issue #1](https://github.com/Dante-Xr/solo-sales/issues/1)、[Issue #2](https://github.com/Dante-Xr/solo-sales/issues/2) 和 [Issue #3](https://github.com/Dante-Xr/solo-sales/issues/3)。
